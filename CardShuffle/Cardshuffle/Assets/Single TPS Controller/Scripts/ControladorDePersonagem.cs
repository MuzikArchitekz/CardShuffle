...
public class ControladorDePersonagem : NetworkBehaviour {

    public int rychlost_chuze;
    public int rychlost_strafu;
    public int rychlost_behu;
    ...
    private void MovePersonagem()
    {
        ...
        if (estado == 1) { transform.Translate(0, 0, rychlost_chuze * Time.deltaTime); }
        if (estado == 2) { transform.Translate(0, 0, rychlost_behu * Time.deltaTime); }
        if (estado == 3) { transform.Translate(0, 0, -rychlost_chuze * Time.deltaTime); }
        if (estado == 4) { transform.Translate(rychlost_strafu * Time.deltaTime, 0, 0); }
        if (estado == 5) { transform.Translate(-rychlost_strafu * Time.deltaTime, 0, 0); }
    }
